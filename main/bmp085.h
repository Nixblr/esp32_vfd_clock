...
#define bmp085_calc_pressure(up)\
		bmp085_get_pressure(up)

#define bmp085_read_ut()\
		bmp085_get_ut()

#define bmp085_read_up()\
		bmp085_get_up()

#define bmp085_read_reg(address, data, length)\
		bmp085_get_reg(address, data, length)

#define bmp085_write_reg(address, data, length)\
		bmp085_set_reg(address, data, length)

#define bmp085_read_cal_param()\
...
void bmp085_setstruct(bmp085_t *bmp085);
